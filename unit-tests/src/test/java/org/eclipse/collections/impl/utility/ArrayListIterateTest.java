...
public class ArrayListIterateTest
{
    ...
    {
        List<Integer> expected = Interval.oneTo(5).addAllTo(new ArrayList<>());
    ...
    public void reverseForEachWithIndex()
    {
        ...
        Assert.assertEquals(MutableList.of(9, 7, 5, 3, 1), reverseResults);
    }
    ...
    public void collect()
    {
        ...
        list.add(Boolean.TRUE);
        list.add(null);
        List<String> newCollection = ArrayListIterate.collect(list, String::valueOf);
    ...
    public void collectOver100()
    {
        ...
        List<Class<?>> newCollection = ArrayListIterate.collect(list, Object::getClass);
    ...
    {
        MutableList<Pair<String, String>> list = MutableList.empty();
        ArrayList<String> list1 = new ArrayList<>(MutableList.of("1", "2"));
        ArrayList<String> list2 = new ArrayList<>(MutableList.of("a", "b"));
    ...
    {
        ArrayList<Integer> list = this.getIntegerList();
        List<Integer> results = ArrayListIterate.select(list, Integer.class::isInstance);
    ...
    {
        ArrayList<Integer> list = this.getIntegerList();
        List<Integer> results = ArrayListIterate.selectWith(list, Predicates2.instanceOf(), Integer.class);
        Verify.assertSize(5, results);
    }
    ...
    public void selectInstancesOfOver100()
    {
        ...
        Assert.assertEquals(ImmutableList.of(102.0), results);
    }
    ...
    public void flatCollect()
    {
        ...
        MutableList<Integer> target1 = MutableList.empty();
    ...
    {
        ArrayList<Integer> list = this.getIntegerList();
        List<Integer> results = ArrayListIterate.rejectWith(list, Predicates2.instanceOf(), Integer.class);
        Verify.assertEmpty(results);
    }
    ...
    public void selectAndRejectWith()
    {
        ...
        Twin<MutableList<Integer>> result =
                ArrayListIterate.selectAndRejectWith(list, Predicates2.in(), ImmutableList.of(1));
    ...
    {
        ArrayList<Integer> list = new ArrayList<>(Interval.oneTo(101));
        List<String> result = ArrayListIterate.collectWith(list, (argument1, argument2) -> argument1.equals(argument2) ? "101" : null, 101);
    ...
    {
        return new ArrayList<>(MutableList.of(items));
    }

    private ThisIsNotAnArrayList<Integer> newNotAnArrayList(Integer... items)
    {
        return new ThisIsNotAnArrayList<>(MutableList.of(items));
    }
    ...
    public void groupByUniqueKeyWithOptimisedList()
    {
        ...
        Assert.assertEquals(
                MutableList.ofAll(list2).groupByUniqueKey(id -> id),
    ...
    public void groupByUniqueKeyWithOptimisedList_target()
    {
        ...
        ArrayList<Integer> list2 = new ArrayList<>(Interval.toReverseList(1, 105));
        Assert.assertEquals(
                MutableList.ofAll(list2).groupByUniqueKey(id -> id, UnifiedMap.newWithKeysValues(0, 0)),
    ...
    public void flattenWithOptimisedArrays()
    {
        ...
        List<Integer> result = ArrayListIterate.flatCollect(list, new CollectionWrappingFunction<>(), new ArrayList<>());
