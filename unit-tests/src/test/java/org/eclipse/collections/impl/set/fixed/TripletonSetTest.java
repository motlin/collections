...
public class TripletonSetTest extends AbstractMemoryEfficientMutableSetTestCase
{
    ...
    public void equalsAndHashCode()
    {
        ...
        MutableSet<String> one = FixedSizeSet.of("1", "2", "3");
    ...
    {
        MutableSet<String> newSet = UnifiedSet.newSet(FixedSizeSet.of("1", "2", "3"));
        newSet.add("4");
    ...
    public void forEach()
    {
        ...
        MutableSet<String> source = FixedSizeSet.of("1", "2", "3");
