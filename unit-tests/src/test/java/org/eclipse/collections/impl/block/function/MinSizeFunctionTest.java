...
public class MinSizeFunctionTest
{
    ...
    {
        Assert.assertEquals(Integer.valueOf(2), MinSizeFunction.MAP.value(2, MutableMap.of(1, 1, 2, 2, 3, 3)));
        Assert.assertEquals(Integer.valueOf(2), MinSizeFunction.MAP.value(3, MutableMap.of(1, 1, 2, 2)));
    }
}
