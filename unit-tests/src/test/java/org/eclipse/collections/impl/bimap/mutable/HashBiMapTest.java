...
public class HashBiMapTest extends AbstractMutableBiMapTestCase
{
    ...
    public void withKeysValues()
    {
        ...
        MutableBiMap<Integer, Character> map22 = map.withKeysValues(1, 'a', 2, 'b');
        ...
        MutableBiMap<Integer, Character> map33 = map.withKeysValues(1, 'a', 2, 'b', 3, 'c');
        ...
        MutableBiMap<Integer, Character> map4 = map3.withKeysValues(4, 'd');
        MutableBiMap<Integer, Character> map44 = map.withKeysValues(1, 'a', 2, 'b', 3, 'c', 4, 'd');
