...
public abstract class AbstractMutableObjectBooleanMapTestCase extends AbstractObjectBooleanMapTestCase
{
    ...
    public void withAllKeyValues()
    {
        ...
        Iterable<ObjectBooleanPair<Integer>> emptyIterable = ImmutableList.empty();
        Iterable<ObjectBooleanPair<Integer>> partialIterable = ImmutableList.of(PrimitiveTuples.pair(Integer.valueOf(1), true), PrimitiveTuples.pair(Integer.valueOf(3), false));
        Iterable<ObjectBooleanPair<Integer>> completeIterable = ImmutableList.of(PrimitiveTuples.pair(Integer.valueOf(1), true), PrimitiveTuples.pair(Integer.valueOf(2), true), PrimitiveTuples.pair(Integer.valueOf(3), false), PrimitiveTuples.pair(Integer.valueOf(4), false));
