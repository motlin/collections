...
public class FixedSizeMapFactoryTest
{
    ...
    public void create0()
    {
        MutableMap<String, String> map = FixedSizeMap.empty();
    ...
    public void create1()
    {
        MutableMap<String, String> map1 = FixedSizeMap.of("key1", "value1");
        Verify.assertSize(1, map1);
        Verify.assertContainsKeyValue("key1", "value1", map1);

        MutableMap<String, String> map2 = FixedSizeMap.of(null, null);
        Verify.assertSize(1, map2);
        Verify.assertContainsKeyValue(null, null, map2);

        MutableMap<String, String> map3 = FixedSizeMap.of(null, "value1");
    ...
    public void create2()
    {
        MutableMap<String, String> map1 = FixedSizeMap.of("key1", "value1", "key2", "value2");
        Verify.assertSize(2, map1);
        Verify.assertContainsAllKeyValues(map1, "key1", "value1", "key2", "value2");

        MutableMap<String, String> map2 = FixedSizeMap.of(null, "value1", "key2", "value2");
    ...
    public void create3()
    {
        MutableMap<String, String> map1 = FixedSizeMap.of("key1", "value1", "key2", "value2", "key3", "value3");
        Verify.assertSize(3, map1);
        Verify.assertContainsAllKeyValues(map1, "key1", "value1", "key2", "value2", "key3", "value3");

        MutableMap<String, String> map2 = FixedSizeMap.of("key1", "value1", "key2", null, null, "value3");
    ...
    {
        MutableMap<String, String> map1 = FixedSizeMap.of("k1", "v1", "k1", "v2");
        Verify.assertSize(1, map1);
        Verify.assertContainsKey("k1", map1);
        Verify.assertContainsKeyValue("k1", "v2", map1);

        MutableMap<String, String> map2 = FixedSizeMap.of("k1", "v1", "k1", "v2", "k1", "v3");
        Verify.assertSize(1, map2);
        Verify.assertContainsKey("k1", map2);
        Verify.assertContainsKeyValue("k1", "v3", map2);

        MutableMap<String, String> map3 = FixedSizeMap.of("k2", "v1", "k3", "v2", "k2", "v3");
        ...
        MutableMap<String, String> map4 = FixedSizeMap.of("k3", "v1", "k4", "v2", "k4", "v3");
    ...
    public void keyPreservation()
    {
        ...
        MutableMap<Key, Integer> map1 = FixedSizeMap.of(key, 1, duplicateKey1, 2);
        Verify.assertSize(1, map1);
        Verify.assertContainsKeyValue(key, 2, map1);
        Assert.assertSame(key, map1.keysView().getFirst());

        Key duplicateKey2 = new Key("key");
        MutableMap<Key, Integer> map2 = FixedSizeMap.of(key, 1, duplicateKey1, 2, duplicateKey2, 3);
        Verify.assertSize(1, map2);
        Verify.assertContainsKeyValue(key, 3, map2);
        Assert.assertSame(key, map1.keysView().getFirst());

        Key duplicateKey3 = new Key("key");
        MutableMap<Key, Integer> map3 = FixedSizeMap.of(key, 1, new Key("not a dupe"), 2, duplicateKey3, 3);
        Verify.assertSize(2, map3);
