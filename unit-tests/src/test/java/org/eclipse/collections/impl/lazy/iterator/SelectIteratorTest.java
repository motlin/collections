...
public class SelectIteratorTest
{
    ...
    {
        Verify.assertThrows(NoSuchElementException.class, () -> new SelectIterator<>(FixedSizeList.empty(), ignored -> true).next());
    }

    @Test
    public void remove()
    {
        Verify.assertThrows(UnsupportedOperationException.class, () -> new SelectIterator<>(FixedSizeList.empty(), ignored -> true).remove());
    }
}
