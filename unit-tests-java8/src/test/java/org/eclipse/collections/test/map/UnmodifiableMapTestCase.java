        ...
        extends MapTestCase
{
    ...
    // It seems like replace and replaceAll would be supported on fixed sized maps since they don't change the size of the map, and replacement is supported through withKeyValue. However, put() and Entry.setValue() both throw.
    @Override
    @Test
