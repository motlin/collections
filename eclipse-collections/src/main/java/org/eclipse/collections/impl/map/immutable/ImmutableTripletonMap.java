        ...
        implements Serializable
{
    ...
    {
        return ImmutableList.of(this.key1, this.key2, this.key3).asLazy();
    }

    @Override
    public RichIterable<V> valuesView()
    {
        return ImmutableList.of(this.value1, this.value2, this.value3).asLazy();
    }
    ...
    public Set<K> keySet()
    {
        return ImmutableSet.of(this.key1, this.key2, this.key3).castToSet();
    }

    @Override
    public Collection<V> values()
    {
        return ImmutableList.of(this.value1, this.value2, this.value3).castToList();
    }
    ...
    {
        return ImmutableMap.of(this.value1, this.key1, this.value2, this.key2, this.value3, this.key3);
    }
    ...
    public <K2, V2> ImmutableMap<K2, V2> collect(Function2<? super K, ? super V, Pair<K2, V2>> function)
    {
        ...
        return ImmutableMap.of(pair1.getOne(), pair1.getTwo(), pair2.getOne(), pair2.getTwo(), pair3.getOne(), pair3.getTwo());
    }

    @Override
    public <R> ImmutableMap<K, R> collectValues(Function2<? super K, ? super V, ? extends R> function)
    {
        return ImmutableMap.of(this.key1, function.value(this.key1, this.value1), this.key2, function.value(this.key2, this.value2), this.key3, function.value(this.key3, this.value3));
    }
