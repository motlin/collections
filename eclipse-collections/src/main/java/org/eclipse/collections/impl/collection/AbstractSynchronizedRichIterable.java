...
public abstract class AbstractSynchronizedRichIterable<T> implements MutableIterable<T>
{
    ...
    {
        return (MutableObjectLongMap<V>) this.delegate.sumByInt(groupBy, function);
    }

    @Override
    public <V> MutableObjectDoubleMap<V> sumByFloat(Function<? super T, ? extends V> groupBy, FloatFunction<? super T> function)
    {
        return (MutableObjectDoubleMap<V>) this.delegate.sumByFloat(groupBy, function);
    }

    @Override
    public <V> MutableObjectLongMap<V> sumByLong(Function<? super T, ? extends V> groupBy, LongFunction<? super T> function)
    {
        return (MutableObjectLongMap<V>) this.delegate.sumByLong(groupBy, function);
    }

    @Override
    public <V> MutableObjectDoubleMap<V> sumByDouble(Function<? super T, ? extends V> groupBy, DoubleFunction<? super T> function)
    {
        return (MutableObjectDoubleMap<V>) this.delegate.sumByDouble(groupBy, function);
    }
